...
# Local server filesystem path to html folder
#server_htdocs = '/Users/ecr/fabio/Sites/ReEDS_Daemon/html/'
server_htdocs = '/var/www/news_link/news_transfer/'

# Web site root directory for project
#web_rundir = "/~fabio/ReEDS_Daemon/html/"
